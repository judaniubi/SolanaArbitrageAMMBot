...
//     online-program-swap:Program<Tmp>,
//     owner:web3.Keypair, 
//     pool_params, 
//     zero_2_one:boolean
...
//     online-program-swap.programId
//   );

//   // A -> B
//   const ix = online-program-swap.instruction.orcaSwap({
//     accounts: {
//       tokenSwap: tokenSwap,
//       authority: authority,
...
//   // Configure the offline-arbitrage-client to use the local cluster.
//   const provider = anchor.Provider.env();
//   const connection = provider.connection;
//   anchor.setProvider(provider);
  
//   const online-program-swap = anchor.workspace.Tmp as Program<Tmp>;
  
//   // load the owner of the tokens 
//   let rawdata = fs.readFileSync(
//     `/Users/brennan/Documents/workspace/solana/orca_local/env/offline-pools-data/owner.key`,
//     'utf8'
//   );  
...
//   if (info == null) {
//     var init_tx = await online-program-swap.rpc.initProgram({
//       accounts: {
//         information: information_pda, 
...
//   var pool_path = '/Users/brennan/Documents/workspace/solana/orca_local/env/offline-pools-data/params_AB.json'
//   const AB_pool_params = decode_poolparams(pool_path)
//   var pool_path = '/Users/brennan/Documents/workspace/solana/orca_local/env/offline-pools-data/params_BC.json'
//   const BC_pool_params = decode_poolparams(pool_path)
//   var pool_path = '/Users/brennan/Documents/workspace/solana/orca_local/env/offline-pools-data/params_CA.json'
//   const CA_pool_params = decode_poolparams(pool_path)

//   const offline-pools-data = [
//     AB_pool_params, 
//     BC_pool_params, 
//     CA_pool_params,
//   ]
...
//   for (let pool of offline-pools-data) {
...
//   for (let pool_params of offline-pools-data) {
...
//     }
//     // track the tokens -> offline-pools-data
...
//   // create a graph of the offline-pools-data
//   let graph = []
...
//   var start_ix = online-program-swap.instruction.startSwap(new anchor.BN(amount_in), {
//     accounts: {
//       information: information_pda, 
//     }
//   });
...
//       var ixsss = await pool_swap_ix(online-program-swap, owner, pool_params, zero_to_one);
//       ixs.push(...ixsss)      
//   }

//   var ix = online-program-swap.instruction.profitOrRevert(new anchor.BN(_start_balance), {
//     accounts: {
